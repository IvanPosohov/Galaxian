...
import ru.ivanp.galaxian.core.BaseManager;
import ru.ivanp.galaxian.core.OnUpdateListener;
import ru.ivanp.galaxian.core.views.BaseView;

public class BackgroundManager extends BaseManager implements OnUpdateListener, BaseView.OnDrawListener {
	// =============================================================================================
	// CONSTANTS
	// =============================================================================================
